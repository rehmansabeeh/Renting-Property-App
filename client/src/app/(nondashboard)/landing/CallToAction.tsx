    ...
    <div className="relative py-24">
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-7 md:mb-0 md:mr-10">
          ...
          <div>
            ...
            <div className="flex justify-center md:justify-start gap-4">
              <button
                ...
                className="inline-block  bg-white text-primary-700 rounded-lg px-6 py-3 font-semibold hover:bg-primary-500 hover:text-primary-50"
              >
                Search
              </button>
              <Link
